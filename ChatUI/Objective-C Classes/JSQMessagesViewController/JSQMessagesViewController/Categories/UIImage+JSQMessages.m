...
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"visitor_chat_box"];
}
...
+ (UIImage *)jsq_defaultCameraImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"camera_icon"];
}
